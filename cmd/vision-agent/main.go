...
func main() {
	...
	webServer.AnalyzeHandler = func(w http.ResponseWriter, r *http.Request) {
		...
		log.Println("Manual observation requested...")
		obs, frame, err := visionTool.AnalyzeCameraFrame("Describe what you see. Keep it short and concise.")
		if err != nil {
	...
	log.Printf("Vision Agent is running. Web UI available at http://localhost%s", webAddr)
